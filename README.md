...
rope forecast --driver sw.swbin --start "2024-06-01 00:00:00" --horizon 24
```

`convert-sw` auto-detects raw CelesTrak vs. ROPE's own CSV format from the header — no flag needed either way.
